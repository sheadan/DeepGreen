...
expt_name = "Duff_Experiment_04b"
data_file_prefix = './data/Duffing_Equation_expt7'  ## FILL IN HERE (from file name)
...
checkpoint_model_path = './model_weights/{}_checkpoint.tf'.format(expt_name)
