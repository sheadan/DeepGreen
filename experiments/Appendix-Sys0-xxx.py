...
'''
This experiment script is the template that was run 100 times to test similarity between
learned latent spaces. In lieu of posting 100 experiment scripts, we post only this script.
'''
