...
for i in range(num_init_models):
    ...
    checkpoint_model_path_aec = './model_weights/{}_checkpoint_aec_{}'.format(expt_name,i)
    ...
    # Train full model
    checkpoint_model_path = './model_weights/{}_checkpoint_{}'.format(expt_name,i)
    ...
    models.append((model, hist, lr, aec_hist, best_loss[0]))
...
best_model_path = "./model_weights/{}_best_aec_model_weights".format(expt_name)
...
aec_losses = []
for i in range(num_init_models):
    _, full_hist, lr, aec_hist, _ = models[i]
...
initial_training = {'aec_only_loss': aec_losses,
                    ...
                    'learn_rates': lrs,
                    'best_lr': best_lr}
init_train_filepath = "./model_weights/{}_initial_train.json".format(expt_name)
